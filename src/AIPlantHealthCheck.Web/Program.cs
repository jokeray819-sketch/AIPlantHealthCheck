...
using AIPlantHealthCheck.Web.Application.IntegrationEventHandlers;
using AIPlantHealthCheck.Web.Clients;
using AIPlantHealthCheck.Web.Extensions;
using FastEndpoints;
using Serilog;
...
try
{
    ...
    app.MapHub<AIPlantHealthCheck.Web.Application.Hubs.ChatHub>("/chat");
    ...
    app.MapGet("/code-analysis", () =>
    {
        var html = VisualizationHtmlBuilder.GenerateVisualizationHtml(
            CodeFlowAnalysisHelper.GetResultFromAssemblies(typeof(Program).Assembly,
                ...
                typeof(AIPlantHealthCheck.Domain.AggregatesModel.OrderAggregate.Order).Assembly)
        );
