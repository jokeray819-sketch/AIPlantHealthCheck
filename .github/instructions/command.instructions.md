---
applyTo: "src/AIPlantHealthCheck.Web/Application/Commands/**/*.cs"
---
...
- 类文件应放置在 `src/AIPlantHealthCheck.Web/Application/Commands/{Module}s/` 目录下（以模块复数形式命名，避免命名空间与聚合类名冲突）。
...
**文件**: `src/AIPlantHealthCheck.Web/Application/Commands/Users/CreateUserCommand.cs`

```csharp
using AIPlantHealthCheck.Domain.AggregatesModel.UserAggregate;
using AIPlantHealthCheck.Infrastructure.Repositories;

namespace AIPlantHealthCheck.Web.Application.Commands.Users;
