---
applyTo: "src/AIPlantHealthCheck.Domain/DomainEvents/*.cs"
---
...
- 类文件应放置在 `src/AIPlantHealthCheck.Domain/DomainEvents` 目录下。
- 为每个聚合添加一个领域事件文件。
...
**文件**: `src/AIPlantHealthCheck.Domain/DomainEvents/UserDomainEvents.cs`

```csharp
using AIPlantHealthCheck.Domain.Aggregates.UserAggregate;
