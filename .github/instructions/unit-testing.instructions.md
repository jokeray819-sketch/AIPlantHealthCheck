...
- 领域层测试：`test/AIPlantHealthCheck.Domain.Tests/{EntityName}Tests.cs`。
- Web 层测试：`test/AIPlantHealthCheck.Web.Tests/{Feature}Tests.cs`。
- 基础设施层测试：`test/AIPlantHealthCheck.Infrastructure.Tests/{Component}Tests.cs`。
