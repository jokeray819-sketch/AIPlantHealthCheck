---
applyTo: "src/AIPlantHealthCheck.Web/Application/DomainEventHandlers/*.cs"
---
...
- 类文件应放置在 `src/AIPlantHealthCheck.Web/Application/DomainEventHandlers/` 目录下。
...
using AIPlantHealthCheck.Web.Domain.DomainEvents;
