---
applyTo: "src/AIPlantHealthCheck.Infrastructure/EntityConfigurations/*.cs"
---
...
- 类文件应放置在 `src/AIPlantHealthCheck.Infrastructure/EntityConfigurations/` 目录下。
- 文件名格式为 `{EntityName}EntityTypeConfiguration.cs`。

## 代码示例

**文件**: `src/AIPlantHealthCheck.Infrastructure/EntityConfigurations/UserEntityTypeConfiguration.cs`
